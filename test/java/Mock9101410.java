...
/**
 * Created by XIANGYANG on 2015-10-22.
 * 翼支付代扣
 */
public class Mock9101410 {
    ...
    public static void main(String[] args) {
        try {
            String xmlmsg = "<?xml version=\"1.0\" encoding=\"GBK\"?>" +
                    "<root>" +
                    "<info>" +
                    "<txncode>9101410</txncode>" +
                    "<userid>HCCBAPP001</userid>" +
                    "<reqsn>HCCB20160414180001</reqsn>" +
                    "<version>1.0</version>" +
                    "<txndate>20160414</txndate>" +
                    "<txntime>180001</txntime>" +
                    "</info>" +
                    "<body>" +
                    "<signId>20160414174934000000000002180767</signId>" +

                    "<iouno>DW005500</iouno>" +
                    "<poano>01</poano>" +
                    "<custid>HCCBCUST002</custid>" +
                    ...
                    "<accountcode>6228480405791326979</accountcode>" +
                    "<bankcardname>蔡晓笛</bankcardname>" +
                    "<certno>41112319930207352X</certno>" +
            ...
            Mock9101410 client = new Mock9101410();
