    ...
    public static void main(String[] args) {
        try {
            String xmlmsg = "<?xml version=\"1.0\" encoding=\"GB2312\"?>" +
                    "<ROOT>" +
                        "<INFO>" +
                            "<TXN_CODE>9009504</TXN_CODE>" +         // 交易代码
                            "<REQ_SN>WY2015102810212755</REQ_SN>" + // 交易流水号
                        "</INFO>" +
                        "<BODY>" +
                            ...
                            "<ADVAMT>1000000.00</ADVAMT>" +             // 支取金额（RETFIX【】）
                            "<ADVDAT>20151115</ADVDAT>" +               // 支取日期（RETFIX【】）
