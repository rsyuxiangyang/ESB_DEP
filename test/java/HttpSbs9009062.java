...
/**
 * 根据账号查询-账户信息9009062
 * (对应SBS-8118交易)根据客户的账号查询客户账户相关信息清单
 */
public class HttpSbs9009062 {
    ...
    public static void main(String[] args) {
        try {
            String xmlmsg = "<?xml version=\"1.0\" encoding=\"GB2312\"?>" +
                    "<ROOT>" +
                        "<INFO>" +
                            "<TXN_CODE>9009062</TXN_CODE>" +         // 交易代码
                            "<REQ_SN>WY2015112408101441</REQ_SN>" + // 交易流水号
                        "</INFO>" +
                        "<BODY>" +
                            "<ACTNUM>801090106001051001</ACTNUM>" +  // 帐号
                        "</BODY>" +
                    "</ROOT>";
