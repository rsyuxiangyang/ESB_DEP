...
public class SbsSktXml9009050 {
    public static void main(String[] args) {
        try {
            String xmlmsg = "<?xml version=\"1.0\" encoding=\"GBK\"?>" +
                    "<ROOT>" +
                    "<INFO>" +
                    "<TXN_CODE>9009050</TXN_CODE>" +
                    "<REQ_SN>201512101422290983</REQ_SN>" +
                    "</INFO>" +
                    "<BODY>" +
                    "<ACTNUM>801003100002013001</ACTNUM>" +
                    "</BODY>" +
                    "</ROOT>";
            String mac = MD5Helper.getMD5String(xmlmsg + "20151210CSPSAPP001CSPS20150918001");
            String reqmsg = "1.00CSPSAPP0019009050   201512101422300000" +
            ...
            //Socket socket = new Socket("10.143.20.153", 62007);
            Socket socket = new Socket("127.0.0.1", 62007);
