    ...
    public static void main(String[] args) {
        try {
            String xmlmsg = "<?xml version=\"1.0\" encoding=\"GB2312\"?>" +
                    "<ROOT>" +
                        "<INFO>" +
                            "<TXN_CODE>9009501</TXN_CODE>" +         // 交易代码
                            "<REQ_SN>WY2015102715291741</REQ_SN>" + // 交易流水号
                        "</INFO>" +
                        "<BODY>" +
                            "<ACTNUM>801000008412011001</ACTNUM>" +  // 帐号（ACTACT【RECSTS=' '】）
                            "<CUSNAM>" +                                 // 客户名
                                StringPad.rightPad4ChineseToByteLength("青岛家电工艺装备研究所", 72, " ") +
                            "</CUSNAM>" +
                            "<PAYTYP>0</PAYTYP>" +                     // 开通网银标志（0-关闭，1-开通 ACTOAC【CQEFLG='3', RECSTS='4'】）
                        "</BODY>" +
                    "</ROOT>";
