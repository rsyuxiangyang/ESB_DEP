...
由tia生成toa
 */
public class Tia9009401ToToa extends AbstractTiaToToa {
    private static Logger logger = LoggerFactory.getLogger(Tia9009401ToToa.class);

    public String transform(String xml, String rtnCode, String errMsg) {
        ToaXml9009401 toa = new ToaXml9009401();
        toa.INFO.TXN_CODE = "9009401";
