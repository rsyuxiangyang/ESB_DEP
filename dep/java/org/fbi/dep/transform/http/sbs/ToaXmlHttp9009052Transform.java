...
public class ToaXmlHttp9009052Transform extends AbstractToaBytesTransform {
    private static Logger logger = LoggerFactory.getLogger(ToaXmlHttp9009052Transform.class);
    ...
    public String transform(byte[] bytes) {
        ...
        if (TxnStatus.TXN_SUCCESS.getCode().equalsIgnoreCase(formCode)) {
            ...
            toa.BODY.DETAILS = new ArrayList<ToaXml9009052.Body.BodyDetail>();
            for (T926.Bean bean : t926.getBeanList()) {
                ToaXml9009052.Body.BodyDetail detail = new ToaXml9009052.Body.BodyDetail();
