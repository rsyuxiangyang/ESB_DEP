 ...
 * ”…tia…˙≥…toa
 */
public class Tia9009501ToToa extends AbstractTiaToToa {
    private static Logger logger = LoggerFactory.getLogger(Tia9009501ToToa.class);

    public String transform(String xml, String rtnCode, String errMsg) {
        ToaXml9009501 toa = new ToaXml9009501();
        toa.getINFO().setTXN_CODE("9009501");
