...
由tia生成toa
 */
public class Tia9009101ToToa extends AbstractTiaToToa {
    private static Logger logger = LoggerFactory.getLogger(Tia9009101ToToa.class);

    public String transform(String xml, String rtnCode, String errMsg) {
        ToaXml9009101 toa = new ToaXml9009101();
        toa.INFO.TXN_CODE = "9009101";
