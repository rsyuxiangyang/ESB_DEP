...
由tia生成toa
 */
public class Tia9109002ToToa extends AbstractTiaToToa {
    private static Logger logger = LoggerFactory.getLogger(Tia9109002ToToa.class);

    public String transform(String xml, String rtnCode, String errMsg) {
        ToaXml9109002 toa = new ToaXml9109002();
        toa.INFO.TXN_CODE = "9109002";
