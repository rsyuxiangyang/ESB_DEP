...
由tia生成toa
 */
public class Tia9109001ToToa extends AbstractTiaToToa {
    private static Logger logger = LoggerFactory.getLogger(Tia9109001ToToa.class);

    public String transform(String xml, String rtnCode, String errMsg) {
        ToaXml9109001 toa = new ToaXml9109001();
        toa.INFO.TXN_CODE = "9109001";
