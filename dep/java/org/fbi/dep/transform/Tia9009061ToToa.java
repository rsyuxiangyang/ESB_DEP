...
由tia生成toa
 */
public class Tia9009061ToToa extends AbstractTiaToToa {
    private static Logger logger = LoggerFactory.getLogger(Tia9009061ToToa.class);

    public String transform(String xml, String rtnCode, String errMsg) {
        ToaXml9009061 toa = new ToaXml9009061();
        toa.INFO.TXN_CODE = "9009061";
