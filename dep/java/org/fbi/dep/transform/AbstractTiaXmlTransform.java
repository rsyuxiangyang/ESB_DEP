 ...
 */
public abstract class AbstractTiaXmlTransform {
    protected static boolean DEP_IS_RUNNING_DEBUG = !"0".equals(PropertyManager.getProperty("dep.running.debug"));
    private static Logger logger = LoggerFactory.getLogger(AbstractTiaXmlTransform.class);
...
//            logger.info(rtnmsg);
    ...
    abstract String transform(String xml);
}
