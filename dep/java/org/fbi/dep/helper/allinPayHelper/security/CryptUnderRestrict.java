...
import org.fbi.dep.helper.allinPayHelper.security.bc.RSADigestSigner;
import org.fbi.dep.helper.allinPayHelper.security.pki.PkiStore;
import org.fbi.dep.helper.allinPayHelper.security.pki.RSAPrivateCrtKeyStructure;
...
/**
 * Created by Lichao.W At 2015/6/24 21:55
 * wanglichao@163.com
 */
public class CryptUnderRestrict implements CryptInf{
    ...
    private RSAKeyParameters getRSAKeyParameters(String certPath) throws Exception
    {
        ...
        PkiStore store = new PkiStore();
        org.fbi.dep.helper.allinPayHelper.security.pki.RSAPublicKeyStructure pkStructure = store.load(certPath);
        BigInteger mod = pkStructure.getModulus();
        BigInteger pubExp = pkStructure.getPubExp();
