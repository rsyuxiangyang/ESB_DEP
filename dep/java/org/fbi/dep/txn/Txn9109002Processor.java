 ...
 * 交易处理 SBS-MBP
 */
public class Txn9109002Processor extends AbstractTxnProcessor {

    private static Logger logger = LoggerFactory.getLogger(Txn9109002Processor.class);
    ...
    public String process(String userid, String msgData) throws ClassNotFoundException, InstantiationException, IllegalAccessException, IOException {
        ...
        TiaXml9109002 tia = (TiaXml9109002) (new TiaXml9109002().getTia(msgData));

        // fip
        Object toa = null;
        try {
            toa = new JmsObjMsgClient().sendRecivMsg("910", "9109002", "fcdep",
