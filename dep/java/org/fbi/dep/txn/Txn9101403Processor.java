...
import org.fbi.dep.model.txn.TiaXml9101403;
...
public class Txn9101403Processor extends AbstractTxnProcessor  {
    private static Logger logger = LoggerFactory.getLogger(Txn9101403Processor.class);
    ...
    public String process(String userid, String msgData) throws ClassNotFoundException,ConversionException, InstantiationException, IllegalAccessException, IOException {
        TiaXml9101403 tia = (TiaXml9101403) (new TiaXml9101403().getTia(msgData));

        // fip
        Object toa = null;
        try {
            toa = new JmsObjMsgClient().sendRecivMsg("910", "9101403", "fcdep",
