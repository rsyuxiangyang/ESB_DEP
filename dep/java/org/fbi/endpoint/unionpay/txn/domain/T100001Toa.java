...
public class T100001Toa {
    ...
    public String toString() {
        ...
        xs.processAnnotations(T100001Toa.class);
        return "<?xml version=\"1.0\" encoding=\"GBK\"?>" + "\n" + xs.toXML(this);
    }

    public static T100001Toa getToa(String xml) {
        XStream xs = new XStream(new DomDriver());
        xs.processAnnotations(T100001Toa.class);
        return (T100001Toa) xs.fromXML(xml);
    }
    ...
    public static void main(String[] argv) {
        ...
        T100001Toa toa = new T100001Toa();

        XStream xs = new XStream(new DomDriver());
        xs.processAnnotations(T100001Toa.class);
        toa = (T100001Toa) xs.fromXML(xml);
