...
@XStreamAlias("ROOT")
public class TiaXml9009504 extends TiaXml {
    private Info INFO;
    private Body BODY;
    ...
    public static class Body implements Serializable{
        ...
        private String ADVDAT; // 支取日期（固定长度yyyyMMdd）
    ...
    public TiaXml getTia(String xml) {
        ...
        xs.processAnnotations(TiaXml9009504.class);
        return (TiaXml9009504) xs.fromXML(xml);
    }
}
